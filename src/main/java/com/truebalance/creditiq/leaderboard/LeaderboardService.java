...
public class LeaderboardService {
    ...
    public LeaderboardService(GameAttemptRepository attemptRepository,
                              AppProperties appProperties) {
        this.attemptRepository = attemptRepository;
        this.appProperties = appProperties;
    }

    public List<LeaderboardEntry> getTop(String gameType) {
        var attempts = attemptRepository.findTopVerifiedByGame(
                gameType, PageRequest.of(0, appProperties.leaderboard().size()));
